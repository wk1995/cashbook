 ...
 * */
data class WalletTradeRecodeShowTitleBean(var mPayAmount: Double = NumberConstants.number_double_zero,
                                          var mInComeAmount: Double = NumberConstants.number_double_zero,
                                          var mDayEndTime: Long=NumberConstants.number_long_zero) :
    ITradeRecodeShowBean {
